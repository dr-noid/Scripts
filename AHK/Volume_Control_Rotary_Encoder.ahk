; This only works for applications that have one PID.
; Or programs in which the active windows PID is the same as the one that handles audio
; Working programs: Spotify, VLC
; Not working programs: Edge, Discord
